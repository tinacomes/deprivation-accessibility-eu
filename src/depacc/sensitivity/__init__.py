...
evaluated on the saved deprivation-free travel times (t_regime_*), so no
re-routing is needed and — the typology being rank-based — they cannot move
the class shares. Layer 3 (accessibility, :mod:`depacc.sensitivity.access`,
